System.register(['angular2/testing', 'angular2/core', './album.component', "./services/music.srv", 'rxjs/Observable', "./models/album", 'angular2/platform/testing/browser', 'angular2/src/router/router', 'angular2/router', 'angular2/src/mock/location_mock', '../app.component'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var testing_1, core_1, album_component_1, music_srv_1, Observable_1, album_1, browser_1, router_1, router_2, location_mock_1, app_component_1;
    ...
    return {
        ...
        execute: function() {
            ...
            testing_1.describe("AlbumComponent", function () {
                ...
                testing_1.it("should show the large cover", testing_1.injectAsync([testing_1.TestComponentBuilder], function (tcb) {
                    return tcb.createAsync(album_component_1.AlbumComponent).then(function (fixture) {
                        fixture.detectChanges();
                        var el = fixture.nativeElement;
